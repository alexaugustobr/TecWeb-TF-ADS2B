...
class Aluno(Usuario):
    curso = models.ForeignKey(on_delete=models.CASCADE, to='Curso', related_name="alunos", null=False, blank=False) #onetomany
    ...
    foto = models.ForeignKey(on_delete=models.CASCADE, to='ArquivosFoto', related_name="alunos", null=True, blank=True) #onetomany
